...
class Server(BasicServer):
    """
    Removing highest samples instance of removing lowest samples 
    """
    ...
    def iterate(self):
        ...
        threshold_score = self.cal_upper_threshold(self.selected_clients)
    ...
    def pack_threshold(self, client_id):
        utils.fmodule.LOG_DICT["thFreshold_score"] = self.threshold_score 
    ...
    def cal_upper_threshold(self, selected_clinets):
        ...
        threshold_value = utils.fmodule.Sampler.cal_upper_threshold(
...
class Client(BasicClient):
    ...
    def reply(self, svr_pkg):
        ...
        selected_idx = utils.fmodule.Sampler.sample_lower_using_cached(self.score_cached,threshold)
