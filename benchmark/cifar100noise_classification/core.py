...
class OurDataset(Dataset):
    ...
    def __getitem__(self, item):
        image, label = self.transform(torch.tensor(self.data[item])),self.labels[item]
        return image, label
...
class TaskReader(object):
    ...
    def load_data(self,):
        ...
        train_dataset = OurDataset("cifar100_bright/x_3.npy", "cifar100_bright/y.json", transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)))
