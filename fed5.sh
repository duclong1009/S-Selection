...
python main.py --session_name "" --group_name "NIID_10client_bias_noisy" --idx_path Dataset_scenarios/NIID_Biasnoisy_10clients.json --proportion 0.5 --algorithm fedalgo5_dev --score all_gnorm_threshold --ratio 1 --noisy_rate_clients 0.3 0.2 0.2 0.1 0.1 0.1 0 0 0 0  --o 1 --u 2.61 