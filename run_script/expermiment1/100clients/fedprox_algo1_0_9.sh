...
#$ -l rt_G.small=1
#$ -l h_rt=72:00:00
#$ -o /home/aaa10078nj/Federated_Learning/Long_SampleSelection/experiment1/fedavg/$JOB_NAME_$JOB_ID.log
#$ -j y
...
python --version
LOG_DIR="/home/aaa10078nj/Federated_Learning/Long_SampleSelection/experiment1/fedavg/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
