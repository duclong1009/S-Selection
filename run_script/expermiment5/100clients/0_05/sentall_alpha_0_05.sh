...
#$ -l rt_G.small=1
#$ -l h_rt=72:00:00
#$ -o /home/aaa10078nj/Federated_Learning/Long_SampleSelection/logs/experiment5/$JOB_NAME_$JOB_ID.log
#$ -j y
...
python --version
LOG_DIR="/home/aaa10078nj/Federated_Learning/Long_SampleSelection/logs/experiment5/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
...
python main.py --num_rounds 1000 --session_name "cluster_20_alpha_0_05" --group_name "experiment5" --proportion 0.3 --algorithm fedalgo1_sentall --ratio 0.8 --aggregate "weighted_com" --task medium_pilldataset --num_classes 150 --data_path ${DATA_DIR} --save_folder_path ${LOG_DIR} --idx_path pill_dataset/medium_pilldataset/100client/dirichlet/data_idx_alpha_0.05_cluster_20.json --score all_gnorm_threshold