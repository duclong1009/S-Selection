...
python main.py --session_name "benchmark" --group_name "gauss_CIFAR10_pareto_10clients_10class" --data_path cifar10/CIFAR10_pareto_10clients_10class --proportion 0.3 --algorithm fedavg --score all_gnorm_threshold --ratio 0.8 --aggregate "weighted_com" --fuzzy_config_path "fuzzylogic_config/config1" --model resnet18 --task cifar10_classification