...
python main.py --num_rounds 500 --session_name "scenario_2" --group_name "NII_medium_pilldataset_100client_unequal" --proportion 0.3 --algorithm fedalgo1 --ratio 0.8 --aggregate "weighted_com" --task medium_pilldataset --num_classes 150 --data_path ${DATA_DIR} --save_folder_path ${LOG_DIR} --idx_path pill_dataset/medium_pilldataset/100client/unequal/data_scenario_2.json --score all_gnorm_threshold