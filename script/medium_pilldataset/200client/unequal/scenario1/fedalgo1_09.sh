...
python main.py --num_rounds 500 --session_name "scenario_1" --group_name "NII_medium_pilldataset_200client_unequal" --proportion 0.3 --algorithm fedalgo1 --ratio 0.9 --aggregate "weighted_com" --task medium_pilldataset --num_classes 150 --data_path ${DATA_DIR} --save_folder_path ${LOG_DIR} --idx_path pill_dataset/medium_pilldataset/200client/unequal/data_scenario_1.json --score all_gnorm_threshold