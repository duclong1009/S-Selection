...
def read_option():
    ...
    # parser.add_argument("--log_flag", action="store_false")
...
if __name__ == "__main__":
    ...
    with open("centrailize/cluster_id.json","r") as f:
        rm_dict = json.load(f)
    ...
    # import os
    # if not os.path.exists(f"centrailize/"):
    #     os.makedirs(f"centrailize/")
    # with open("centrailize/result.json","w") as f:
